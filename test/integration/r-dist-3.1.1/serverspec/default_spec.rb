...
describe 'cookbook-r::default' do
  ...
  it 'installs the required r packages with correct version' do
    expect(package 'r-base').to be_installed.with_version('3.1.1-1trusty0')
    expect(package 'r-base-core').to be_installed.with_version('3.1.1-1trusty0')
    expect(package 'r-base-dev').to be_installed.with_version('3.1.1-1trusty0')
    ...
    expect(package 'r-recommended').to be_installed.with_version('3.1.1-1trusty0')
  end
end
